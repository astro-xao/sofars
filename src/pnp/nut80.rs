...
impl Coeff {
    pub const fn new(nl: i32, nlp: i32, nf: i32, nd: i32, nom: i32, sp: f64, spt: f64, ce: f64, cet: f64) -> Self {
        Self { nl, nlp, nf, nd, nom, sp, spt, ce, cet }
    }
}
