...
///      equinox and ecliptic of date.  For the utmost accuracy, use the
///      iauPn00 function, where the nutation components are caller-
///      specified.
///
...
///
///  8)  The matrix rbppn transforms vectors from GCRS to true equator and
